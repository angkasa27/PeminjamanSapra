...
$status = "Belum";
$id = $_SESSION['id'];
$pengajuan = query("SELECT * FROM peminjaman WHERE status = '$status' AND id_pegawai = '$id' LIMIT $awalData, $jumlahMaxData");
      ...
      <div class="row">
        ...
        <div class="card text-center bg-dark col-md-8">
          ...
          <form action="" method="post" class="form-inline">
            <h2 class="gaya text-light col-md-4">Menunggu</h2>
            <a href="selesai.php" class="btn btn-primary mb-2 gaya jarak btn-sm"><i class="fas fa-history"></i></a>
            <a href="pengajuanpinjam.php" class="btn btn-primary mb-2 gaya jarak btn-sm ml-2"><i class="fas fa-plus"></i></a>
          ...
          <div class="table-responsive">
            <table class="table table-bordered text-center text-light table-sm ">
              ...
              <?php endforeach; ?>
            <?php }else{?>
              <h4 class="text-warning">Tidak ada pengajuan</h4 class="text-warning">
            <?php } ?>
              </tbody>
            </table>
            </div>

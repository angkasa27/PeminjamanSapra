...
$pegawai = query("SELECT * FROM pegawai ORDER BY nama_pegawai ASC LIMIT $awalData, $jumlahMaxData");
      ...
      <div class="row">
        ...
        <div class="card text-center bg-dark col-md-8">
          ...
          <form action="" method="post" class="form-inline">
            <h2 class="gaya text-light col-md-3">Pegawai</h2>
            <a href="add_pegawai.php" class="btn btn-primary mb-2 col-md-1 gaya jarak"><i class="fas fa-plus"></i></a>
            ...
            <table class="table table-bordered text-center text-light table-sm ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $row["alamat"] ?></td>
                  <td>
                    <a href="edit_pegawai.php?id_pegawai=<?= $row["id_pegawai"] ?>" class="btn btn-success   btn-sm"><i class="fas fa-edit"></i></a>
                    <a href="delete.php?id_pegawai=<?= $row["id_pegawai"] ?>" onclick="return confirm('yakin?')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                <?php $i++ ?>
              <?php endforeach; ?>

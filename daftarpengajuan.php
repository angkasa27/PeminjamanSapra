...
$status = "Belum";
$pengajuan = query("SELECT * FROM peminjaman WHERE status = '$status' LIMIT $awalData, $jumlahMaxData");
...
<html lang="en">
  ...
  <body  class="bg-secondary">
    ...
    <form action="" method="post" class="form-inline">
            <h2 class="gaya text-light col-md-4">Pengajuan</h2>
            <a href="pinjam.php" class="btn btn-primary mb-2 col-md-1 gaya jarak"><i class="fas fa-clock"></i></a>
            <a href="historyadmin.php" class="btn btn-primary mb-2 col-md-1 gaya jarak"><i class="fas fa-history"></i></a>
            ...
            <table class="table table-bordered text-center text-light table-sm ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $row["status"] ?></td>
                  <td>
                    <a href="terima.php?id_pinjam=<?= $row["id_pinjam"] ?>" onclick="return confirm('yakin?')" class="btn btn-success  btn-sm"><i class="fas fa-check"></i></a>
                    <a href="tolak.php?id_pinjam=<?= $row["id_pinjam"] ?>" onclick="return confirm('yakin?')" class="btn btn-danger btn-sm"><b>X</b></a>
                  </td>
                </tr>
                <?php $i++ ?>
              <?php endforeach; ?>
